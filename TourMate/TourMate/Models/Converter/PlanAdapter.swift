...
extension Accommodation {
    fileprivate func toData() -> FirebaseAdaptedAccommodation {
        FirebaseAdaptedAccommodation(id: id, tripId: tripId, planType: FirebasePlanType(rawValue: planType.rawValue)!, name: name,
...
extension Activity {
    fileprivate func toData() -> FirebaseAdaptedActivity {
        FirebaseAdaptedActivity(id: id, tripId: tripId, planType: FirebasePlanType(rawValue: planType.rawValue)!, name: name,
                                startDate: startDate, endDate: endDate,
                                timeZone: timeZone, imageUrl: imageUrl, status: status.rawValue,
                                creationDate: creationDate, modificationDate: modificationDate,
...
extension Restaurant {
    fileprivate func toData() -> FirebaseAdaptedRestaurant {
        FirebaseAdaptedRestaurant(id: id, tripId: tripId, planType: FirebasePlanType(rawValue: planType.rawValue)!, name: name,
                                  startDate: startDate, endDate: endDate,
                                  timeZone: timeZone, imageUrl: imageUrl, status: status.rawValue,
                                  creationDate: creationDate, modificationDate: modificationDate,
                                  address: address, phone: phone, website: website)
...
extension Transport {
    fileprivate func toData() -> FirebaseAdaptedTransport {
        FirebaseAdaptedTransport(id: id, tripId: tripId, planType: FirebasePlanType(rawValue: planType.rawValue)!, name: name,
                                 startDate: startDate, endDate: endDate,
                                 timeZone: timeZone, imageUrl: imageUrl, status: status.rawValue,
                                 creationDate: creationDate, modificationDate: modificationDate,
                                 departureLocation: departureLocation, departureAddress: departureAddress, arrivalLocation: arrivalLocation,
                                 arrivalAddress: arrivalAddress, vehicleDescription: vehicleDescription, numberOfPassengers: numberOfPassengers)
    }
}

extension Flight {
    fileprivate func toData() -> FirebaseAdaptedFlight {
        FirebaseAdaptedFlight(id: id, tripId: tripId, planType: FirebasePlanType(rawValue: planType.rawValue)!, name: name,
                              startDate: startDate, endDate: endDate,
                              timeZone: timeZone, imageUrl: imageUrl, status: status.rawValue,
                              creationDate: creationDate, modificationDate: modificationDate,
...
extension FirebaseAdaptedAccommodation {
    fileprivate func toItem() -> Accommodation {
        Accommodation(id: id, tripId: tripId, planType: PlanType(rawValue: planType.rawValue)!, name: name,
                      startDate: startDate, endDate: endDate,
...
extension FirebaseAdaptedActivity {
    fileprivate func toItem() -> Activity {
        Activity(id: id, tripId: tripId, planType: PlanType(rawValue: planType.rawValue)!, name: name,
                 startDate: startDate, endDate: endDate,
                 timeZone: timeZone, imageUrl: imageUrl, status: PlanStatus(rawValue: status)!,
                 creationDate: creationDate, modificationDate: modificationDate,
                 venue: venue, address: address, phone: phone, website: website)
...
extension FirebaseAdaptedRestaurant {
    fileprivate func toRestaurant() -> Restaurant {
        Restaurant(id: id, tripId: tripId, planType: PlanType(rawValue: planType.rawValue)!, name: name,
                   startDate: startDate, endDate: endDate,
                   timeZone: timeZone, imageUrl: imageUrl, status: PlanStatus(rawValue: status)!,
                   creationDate: creationDate, modificationDate: modificationDate,
                   address: address, phone: phone, website: website)
...
extension FirebaseAdaptedTransport {
    fileprivate func toItem() -> Transport {
        Transport(id: id, tripId: tripId, planType: PlanType(rawValue: planType.rawValue)!, name: name,
                  startDate: startDate, endDate: endDate,
                  timeZone: timeZone, imageUrl: imageUrl, status: PlanStatus(rawValue: status)!,
                  creationDate: creationDate, modificationDate: modificationDate,
                  departureLocation: departureLocation, departureAddress: departureAddress, arrivalLocation: arrivalLocation,
...
extension FirebaseAdaptedFlight {
    fileprivate func toItem() -> Flight {
        Flight(id: id, tripId: tripId, planType: PlanType(rawValue: planType.rawValue)!, name: name,
               startDate: startDate, endDate: endDate,
               timeZone: timeZone, imageUrl: imageUrl, status: PlanStatus(rawValue: status)!,
               creationDate: creationDate, modificationDate: modificationDate,
               airline: airline, flightNumber: flightNumber, seats: seats, departureLocation: departureLocation,
